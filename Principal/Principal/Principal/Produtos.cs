...
public void RealizarVendas(int pedidoID, DateTime data, decimal valor,int clienteID, int itemNum,
...
cmd.Parameters.AddWithValue("produtoID", produtoID);
cmd.Parameters.AddWithValue("@qtdade", qtdade);
//Executa o comando para realizar a baixa na qtdade estocada do produto no banco de dado
cmd.ExecuteNonQuery();
}
catch (Exception ex)
{
